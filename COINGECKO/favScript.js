...
// CARREGA TODOSO OS IDS GUARDADOS NOS FAVORITOS
var fav = [];
...
var baseURL = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=eur&ids="+IdsStr;
...
$(document).ready(function(){
    ...
    $(document).on("click", ".fav-btn", function() {
        ...
        // GUARDA AS ALTERAÇÕES E FAZ REFRESH NA PÁGINA
